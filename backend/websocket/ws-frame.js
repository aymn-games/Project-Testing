/**
 * AGP WS FRAME — تشفير/فك رسائل WebSocket (RFC 6455) يدوياً، بدون مكتبة
 * خارجية. تدعم: نص، إغلاق، Ping/Pong فقط — لا تجزئة (fragmentation) ولا
 * رسائل ثنائية (غير مطلوبة لبروتوكول AGP: JSON نصي صغير فقط).
 */

/**
 * AGP DASHBOARD — إعدادات روليت القبائل + حالة اللعبة الحيّة (عرض فقط).
 *
 * ⚠️ حقول الإعدادات أدناه (الانعاش، الإقصاء المؤقت، التذاكر) غير مقروءة
 *   فعلياً من اللعبة الحالية — تبقى محفوظة هنا لليوم اللي تُضاف فيه هذي
 *   الميزات داخل اللعبة نفسها.
 */

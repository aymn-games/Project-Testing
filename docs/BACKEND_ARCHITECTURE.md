...
the WebSocket message protocol in §3–§4. The real swap point turned out
to be `connector-router.js` (backend-side), not a frontend file swap —
see §6 for why that's the cleaner outcome.
